...
# variant_data_subset <- feather::read_feather("raw-data/variant_data_subset.feather")
```
...
```{r}
# library(DT)
# datatable(iris, class = 'cell-border stripe', options = list(pageLength = 4, dom = 'tip')) |> 
#   formatStyle(
#     columns = colnames(iris),  # Specify columns to style
#     fontSize = '18px'
#   )
...
# datatable(iris, class = 'cell-border stripe', options = list(pageLength = 4, dom = 'tip')) %>% 
#   formatStyle(
#     columns = colnames(iris),  # Apply font size to all data columns
#     fontSize = '18px'
#   ) %>% 
#   tags$head(
#     tags$style(HTML("
#       .dataTables_wrapper .dataTable th {
#         font-size: 14px; /* Decrease font size for column headers */
#       }
#     "))
#   )
```
...
# library(DT)
# library(htmltools)
# write.csv(variant_data_subset, "/Users/danielhintz/Library/CloudStorage/Dropbox/Embedding_Presentation/raw-data/variant_data_subset.csv")
# 
# variant_data_subset <- read.csv("/Users/danielhintz/Library/CloudStorage/Dropbox/Embedding_Presentation/raw-data/variant_data_subset.feather")
# variant_data_subset <- feather::read_feather("/Users/danielhintz/Library/CloudStorage/Dropbox/Embedding_Presentation/raw-data/variant_data_subset.feather")
# # Define the datatable
# dt <- datatable(variant_data_subset, class = 'cell-border stripe', options = list(pageLength = 4, dom = 'tip'), 
#                 callback = JS("table.columns().header().to$().css({'font-size': '10px'});")) %>% 
#   formatStyle(
#     columns = colnames(iris),  # Apply font size to all data columns
#     fontSize = '10px'
#   )
# 
# # Create a custom HTML structure with embedded CSS
# htmlOutput <- tags$html(
#   tags$head(
#     tags$style(HTML("
#       .dataTable th {
#         font-size: 10px !important; /* Using !important to ensure override */
#       }
#     "))
#   ),
#   dt
